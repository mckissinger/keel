...
- The flakes ledger — every open `specs/flakes/<slug>.md` (the `README.md` documents the convention; entries are drained by a batch chore): the attached path, its measured reproduction rate, and its hit count.

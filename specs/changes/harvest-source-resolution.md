...
**Draft 4.** Three earlier drafts failed their adversarial pass. This document is rewritten
...
- **Floor = one global watermark line**, seeded `2026-07-18`. Safe rather than assumed: the only
  two sources still marked through 07-12 have zero sessions after that date (newest 2026-06-22
  and 2026-07-06, verified), so the collapse loses no coverage.
